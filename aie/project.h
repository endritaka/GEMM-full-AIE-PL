...
public:
  ...
  simpleGraph(){
	  ...
	  for (int i = 0; i < mult_X * mult_Y; i++){
		  A[i] = input_plio::create("A" + std::to_string(i), plio_128_bits, "data/matA" + std::to_string(i) + ".txt");
	  }
	  ...
	  for (int i = 0; i < mult_Y * mult_Z; i++){
		  B[i] = input_plio::create("B" + std::to_string(i), plio_128_bits, "data/matB" + std::to_string(i) + ".txt");
	  }

	  // C: 0   1    2  ...
	  //    x  x+1  x+2 ...
	  for (int i = 0; i < mult_X * mult_Z; i++){
		  C[i] = output_plio::create("C" + std::to_string(i), plio_128_bits, "data/matC" + std::to_string(i) + ".txt");
	  }
